...
// com.hitesh.amrita.FileTransferServer class
class FileTransferServer extends File_Server_Transfer {
    ...
    void start() {
        try {
            ...
            System.out.println("com.hitesh.amrita.Server started. Listening on port 8080...");
            while (true) {
...
public class Server {
    public static void main(String[] args) {
        ...
        // Implement com.hitesh.amrita.FileTransferListener
