...
/**
 * The ArrayListExample class demonstrates the usage of ArrayList to store and manipulate a collection of student roll numbers.
 * It creates an ArrayList of student roll numbers, adds student roll numbers to it, and performs operations to manipulate the ArrayList.
 ...
 * - It performs operations to manipulate the ArrayList, such as removing a specific roll number.
 *
...
public class ArrayListExample {
     ...
     * It demonstrates the usage of ArrayList to store and manipulate a collection of student roll numbers.
     *
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Initial roll numbers:");
        for (String rollNumber : u21cys) {
            System.out.println(rollNumber);
        }

        String rollNumberToRemove = "CB.EN.U4CYS22028";
        u21cys.remove(rollNumberToRemove);
